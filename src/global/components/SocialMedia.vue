<template>
  <ul class="d-flex social-media">
    <li class="social-media__item">
      <a
        href="https://www.facebook.com/pages/category/Software-Company/MetraBit-Digital-Agency-734388440243441/"
        target="_blank"
      >
    ...
    <li class="social-media__item">
      <a href="https://www.instagram.com/metrabitagency/" target="_blank">
        <svg viewBox="0 0 24 24">
          <path
